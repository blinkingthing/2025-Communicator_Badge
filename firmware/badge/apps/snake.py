...
class SnakeApp(BaseApp):
    ...
    def reset_game(self):
        ...
        # Clean up old LVGL objects first with error handling
    ...
    def switch_to_foreground(self):
        ...
        self.score_label.set_pos(180, 2)  # Approximately centered
    ...
    def draw_game(self):
        ...
        # Clear old snake blocks with error handling
        for block in self.snake_blocks:
            if block:
                try:
                    block.delete()
    ...
    def run_foreground(self):
        ...
        if (new_head[0] < 0 or new_head[0] >= self.grid_width or
            ...
            if not self.game_over_label:
                ...
                self.game_over_label.set_pos(150, 60)  # Approximately centered
            return
    ...
    def switch_to_background(self):
        ...
        # Clean up LVGL objects with error handling
        for block in self.snake_blocks:
            if block:
                try:
                    block.delete()
